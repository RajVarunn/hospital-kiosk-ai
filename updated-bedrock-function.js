/**
 * Updated bedrockTest function using AWS SDK v2
 * Replace your current bedrockTest function with this one
 */
...
`;
  ...
  try {
    ...
    AWS.config.update({ 
      region: 'us-west-2',
      // Use hardcoded credentials for testing - replace with your own
      credentials: {
